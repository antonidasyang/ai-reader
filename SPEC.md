...
4. **M4 — Chat pane (week 7–8)**: cmark-gfm pipeline → typed QML items, `MathBlock` (MicroTeX), `CodeBlock` (KSyntaxHighlighting), streaming, selection-as-quote, all 7 tools wired with user-configurable budget (default 30). (D5–D6)
